...
function michigan_webnus_setup_assets(){
...
add_action('wp_enqueue_scripts', 'michigan_webnus_setup_assets');
function michigan_webnus_setup_admin_assets(){
...
add_action('admin_enqueue_scripts','michigan_webnus_setup_admin_assets');
?>