...
class Michigan_Webnus_MyGallery
{
	...
	function filter_mce_plugin( $plugins ) {
		// this plugin file will work the magic of our button
                ...
                $plugins['michigan_webnus_button'] = get_template_directory_uri() . '/inc/editor/nc-sc.js';
...
$mygallery = new Michigan_Webnus_MyGallery();
