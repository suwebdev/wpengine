 ...
 */
(function() {
    tinymce.create('tinymce.plugins.michigan_webnus_button', {
        init: function(ed, url) {
            ed.addButton('michigan_webnus_button', {
                title: 'Button',
    ...
    tinymce.PluginManager.add('michigan_webnus_button', tinymce.plugins.michigan_webnus_button);
 ...
 function distance_form() //distance
    {
        ...
        var form = jQuery('<div id="distance-form"><table id="distance-table" class="form-table">\
				<tr>\
					...
					<td><select id="distance-type"><option value="1">Distance 1</option><option value="2">Distance 2</option><option value="3">Distance 3</option><option value="4">Distance 4</option><option value="5">Distance 5</option></select><br />\
        ...
        form.find('#distance-submit').click(function() {
            ...
            var shortcode = '[distance type="'+ distance_type +'"]';
            // inserts the shortcode into the active editor
