 ...
 * @version   2.6.1 for parent theme michigan for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function load_textdomain() {
			...
			if ( false !== strpos( __FILE__, WP_PLUGIN_DIR ) || false !== strpos( __FILE__, WPMU_PLUGIN_DIR ) ) {
				...
				load_theme_textdomain( 'tgmpa', get_template_directory() . '/inc/plugins/plugin-activator/languages' );
