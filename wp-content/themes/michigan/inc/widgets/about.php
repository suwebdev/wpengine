<?php class WebnusAboutWidget extends WP_Widget{
	...
	public function form($instance){
		...
		<p><label for="<?php echo $this->get_field_id('description') ?>"><?php esc_html_e('Description:','michigan'); ?></label><textarea class="widefat" id="<?php echo $this->get_field_id('description') ?>" name="<?php echo $this->get_field_name('description') ?>"><?php if( isset($description) )  echo esc_attr($description); ?></textarea></p>
		<?php 
	}
...
add_action('widgets_init','register_michigan_webnus_about_widget'); 
function register_michigan_webnus_about_widget(){
