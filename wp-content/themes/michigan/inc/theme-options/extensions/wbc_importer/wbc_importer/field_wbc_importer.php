        ...
        public function render() {
            ...
            echo '<div id="info-opt-notice-warning w-clearfix" class="redux-warning   redux-info-field redux-field-info" style="display: block; clear: both; overflow: hidden;">
                        <p class="redux-info-desc"><b>Is your menu duplicated or not imported ?</b><br>
                            If your menu is duplicated or not imported after importing demo please read <a target="_blank" href="https://webnus.ticksy.com/article/8197/">How To Remove Duplicated Menu Items After Importing</a> Article
                        </p>
                    </div>';
            echo '</fieldset></td></tr>';
