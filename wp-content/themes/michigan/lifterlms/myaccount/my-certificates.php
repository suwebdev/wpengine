...
<div class="llms-sd-section llms-my-certificates w-llms-my-certificates">
	<h3><i class="fa-chevron-right"></i> <?php echo apply_filters( 'lifterlms_my_certificates_title', __( 'My Certificates', 'lifterlms' ) ); ?></h3>
	<?php if ( $certificates ) : ?>
