...
?>
<div class="llms-sd-section llms-my-achievements w-llms-my-achievements">
	<h3><i class="fa-chevron-right"></i> <?php echo apply_filters( 'lifterlms_my_achievements_title', __( 'My Achievements', 'lifterlms' ) ); ?></h3>
