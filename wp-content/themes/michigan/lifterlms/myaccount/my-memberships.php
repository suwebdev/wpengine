...
<div class="llms-sd-section llms-my-memberships w-llms-my-memberships">
	<h3><i class="fa-chevron-right"></i> <?php echo apply_filters( 'lifterlms_my_memberships_title', __( 'My Memberships', 'lifterlms' ) ); ?></h3>
