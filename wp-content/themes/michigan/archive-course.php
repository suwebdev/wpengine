    ...
    <main class="container content llms-content w-course-archive">
        ...
        if ( have_posts() ){
            ...
            $students = $wpdb->get_results($wpdb->prepare(
                'SELECT user_id,meta_value,post_id  FROM '.$wpdb->prefix . 'lifterlms_user_postmeta
            ...
            $classes = array();
            global $course;
            $lms_lenght = (class_exists('LLMS_Product'))? $course->get_lesson_length():'';
                ...
                <article class="w-course-list">
                    ...
                    <div class="col-md-8 none-grid">
                        <div class="course-list-content">
                            ...
                            echo ($course_price)?'<div class="course-list-price">'.$course_price.'</div>':'';
