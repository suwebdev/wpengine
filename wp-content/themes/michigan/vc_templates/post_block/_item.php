...
<?php } ?>
<?php if($block === 'link'){ ?>
	<a href="<?php echo esc_url($post->link); ?>" class="vc_read_more" title="<?php echo esc_attr(sprintf(__( 'Permalink to', 'michigan' ).' %s', $post->title_attribute)); ?>"<?php echo $this->link_target ?>><?php esc_html_e('Read more', 'michigan') ?></a>
<?php } ?>
